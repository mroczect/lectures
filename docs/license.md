---
title: License
description: Licensing information for the Lectures project — CC BY-NC-SA 4.0. Learn what you can do, what you must do, and what you cannot do with this content.
layout: home

hero:
  name: License
  text: CC BY-NC-SA 4.0
  tagline: Free to share, adapt, and learn from — as long as you give credit, stay non-commercial, and pass on the same freedoms to others.
  actions:
    - theme: brand
      text: Quick Summary
      link: '#quick-summary'
...
features:
  - title: Share Freely
    details: Copy and redistribute the material in any format or medium — no permission needed.
  - title: Adapt Freely
    details: Remix, modify, and build upon the material for any non-commercial purpose.
  - title: Attribution Required
    details: You must give appropriate credit to the original creator — Muhammad Riduwan Khafidi.
  - title: NonCommercial
    details: You may not use the material for commercial purposes or for sale.
  - title: ShareAlike
    details: Derivative works must be licensed under the same terms — no relicensing to more permissive terms.
  - title: Third-Party Excluded
    details: Lecturer materials, slides, PDFs, and e-learning resources are not covered by this license.
---
...
```mermaid
mindmap
  root((CC BY-NC-SA 4.0<br/>Summary))
    You CAN
      Share the material
        Any format
        Any medium
...
```mermaid
flowchart TB
    ROOT["Lectures Repository"]

    ROOT --> COVERED["Covered by<br/>CC BY-NC-SA 4.0"]
    ROOT --> EXCLUDED["Not Covered<br/>(Third-Party)"]

    COVERED --> C1["Personal Notes<br/>& Summaries"]
    COVERED --> C2["Course Page<br/>Content"]
    COVERED --> C3["Configuration<br/>Code & Scripts"]
    COVERED --> C4["Documentation<br/>Structure"]

    EXCLUDED --> E1["Lecturer<br/>Slides"]
    EXCLUDED --> E2["PDFs from<br/>E-Learning"]
    EXCLUDED --> E3["Videos<br/>& Multimedia"]
    EXCLUDED --> E4["External<br/>Resources"]

    style COVERED fill:#3e63dd,color:#fff
    style EXCLUDED fill:#a63434,color:#fff
```
...
```mermaid
flowchart LR
    TP["Third-Party<br/>Materials"]
    TP --> H1["Course<br/>Lecturer"]
    TP --> H2["TRPL Study<br/>Program (D4)"]
    TP --> H3["Politeknik<br/>Negeri Batam"]
    TP --> H4["Original Author<br/>/ Publisher"]

    style TP fill:#a63434,color:#fff
```
...
```mermaid
flowchart TB
    V["Violation<br/>Detected"]
    V --> S1["Commercial use<br/>without permission"]
    V --> S2["Attribution<br/>removed"]
    V --> S3["Relicensed to<br/>more permissive terms"]
    V --> S4["Third-party content<br/>redistributed"]

    S1 --> C1["Cease and desist<br/>DMCA takedown"]
    S2 --> C2["Attribution restoration<br/>Public correction"]
    S3 --> C3["License termination<br/>for violator"]
    S4 --> C4["Copyright infringement<br/>Legal liability"]

    style V fill:#a63434,color:#fff
