...
[`LICENSE`](https://github.com/mroczect/lectures/blob/master/LICENSE) file.

::: info Quick Summary
You are free to **share** and **adapt** this material for non-commercial
purposes, as long as you give **attribution** and license derivatives under
the **same terms**.
:::
...
- [x] **Share** — copy and redistribute the material in any format
- [x] **Adapt** — remix, modify, and build upon the material
- [x] **Use** — for personal, educational, or non-commercial purposes

### Conditions to Meet

- [ ] **Attribution** — give credit to the original creator
- [ ] **NonCommercial** — not for sale or commercial purposes
...
- Change the license of derivative works to be more permissive

::: warning Not Allowed
Selling, sublicensing, or relicensing this material under more permissive
...
| Section                                   | Status          |
| ----------------------------------------- | --------------- |
| Personal notes & summaries                | CC BY-NC-SA 4.0 |
| Configuration code & scripts              | CC BY-NC-SA 4.0 |
| Lecturer materials (slides, PDFs, videos) | Not owned by us |
| E-learning resources                      | Not owned by us |
...
Lecture materials provided by lecturers — including slides, PDFs, videos,
and resources from e-learning platforms — are **not covered** by this license.
...
If you use or redistribute material from this project, please provide
...
Have questions about this license? Contact:

- **Email**: [mriduwankhafidi@proton.me](mailto:mriduwankhafidi@proton.me)
- **GitHub**: [github.com/mroczect/lectures](https://github.com/mroczect/lectures)

---

## Official Links

- [Full License Text (CC BY-NC-SA 4.0)](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.txt)
