...
description: Halaman mata kuliah PK001RPL Pendidikan Agama — Program Studi Teknologi Rekayasa Perangkat Lunak, Politeknik Negeri Batam.
layout: home

hero:
  name: PK001RPL
  text: Pendidikan Agama
  tagline: Membangun karakter, etika, dan integritas sebagai fondasi perekayasa perangkat lunak profesional — nilai yang berlaku di dalam kode dan di luar kode.
  actions:
    - theme: brand
...
features:
  ...
  - title: Pembentukan Karakter
    details: Fokus pada pengembangan nilai, etika, dan integritas sebagai calon profesional di bidang teknologi.
  - title: Etika Profesi
    details: Menghubungkan nilai keagamaan dengan etika kerja, tanggung jawab sosial, dan integritas akademik.
  - title: Bukan Sekadar Teori
    details: Nilai-nilai yang dibangun di sini relevan langsung untuk kerja tim, kolaborasi, dan refleksi di proyek PBL.
  - title: Paralel dengan PBL
    details: Berjalan seiring proyek PBL semester 1 — bukan terhubung teknis, tapi memperkuat sisi manusiawinya.
  - title: E-Learning Terintegrasi
    details: Semua materi, tugas, dan aktivitas terpusat di e-learning IF Polibatam.
---
...
```mermaid
flowchart TB
    subgraph INTI["INTI PEMBELAJARAN · PK001RPL"]
        direction TB
        I1["Nilai & Etika<br/>Keagamaan"]
        I2["Karakter &<br/>Integritas"]
        I3["Tanggung Jawab<br/>Sosial"]
        I4["Etika Profesi<br/>& Akademik"]
    end

    subgraph APLIKASI["APLIKASI DALAM PERKULIAHAN"]
        direction LR
        A1["Kerja Tim<br/>di Proyek PBL"]
        A2["Integritas<br/>Akademik"]
        A3["Etika<br/>Komunikasi"]
        A4["Tanggung Jawab<br/>Profesional"]
    end

    INTI ==> APLIKASI

    style INTI fill:#3e63dd,color:#fff
    style APLIKASI fill:#2f6f4e,color:#fff
```
...
```mermaid
mindmap
  root((PK001RPL<br/>Pendidikan<br/>Agama))
    Nilai
      Keagamaan
      Moral
      Etika
...
```mermaid
flowchart LR
    PK["PK001RPL<br/>Pendidikan<br/>Agama"]

    PK -.->|Integritas| RPL101["RPL101<br/>Pengantar RPL"]
    PK -.->|Etika Kerja| RPL102["RPL102<br/>Algoritma"]
    PK -.->|Disiplin| RPL103["RPL103<br/>Matematika"]
    PK -.->|Tanggung Jawab| RPL104["RPL104<br/>Analisis Kebutuhan"]
    PK -.->|Kerja Sama| RPL105["RPL105<br/>Web Programming"]
    PK -.->|Kejujuran| RPL106["RPL106<br/>Basis Data"]

    style PK fill:#3e63dd,color:#fff
    style RPL101 fill:#6a6a71,color:#fff
    style RPL102 fill:#6a6a71,color:#fff
    style RPL103 fill:#6a6a71,color:#fff
    style RPL104 fill:#6a6a71,color:#fff
    style RPL105 fill:#6a6a71,color:#fff
    style RPL106 fill:#6a6a71,color:#fff
```
...
```mermaid
flowchart TB
    A["Nilai Keagamaan"] --> B["Etika Akademik"]
    B --> C["Praktik Nyata"]
    C --> D1["Kejujuran dalam<br/>mengerjakan tugas"]
    C --> D2["Tanggung jawab<br/>dalam tim PBL"]
    C --> D3["Disiplin<br/>kehadiran & tenggat"]
    C --> D4["Empati dalam<br/>diskusi kelompok"]
    C --> D5["Refleksi diri<br/>atas kesalahan"]
