...
| Halaman                                                                                                                             | Deskripsi                                    |
| ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| [Pertemuan 1 — Introduction to Database Concepts](/v1/courses/rpl106-pengantar-basis-data/materi-01-introduction-database-concepts) | Materi sebelumnya — konsep dasar basis data. |
| [Halaman Mata Kuliah RPL106](/v1/courses/rpl106-pengantar-basis-data/)                                                              | Overview mata kuliah.                        |
