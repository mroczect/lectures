...
| :-------: | ---------------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------- |
|     1     | Pengenalan Basis Data  | Konsep dasar, basis data relasional                   | [Materi](/docs/v1/courses/rpl106-pengantar-basis-data/introduction-database-concepts) |
...
<details>
<summary>Contoh Kode — Pemetaan ER ke Skema Relasional</summary>
...
<details>
<summary>Contoh Kode — Query Kompleks</summary>
...
<details>
<summary>Contoh Kode — DCL & View</summary>
...
<details>
<summary>Kognitif ATS (Teori & Praktik)</summary>
...
<details>
<summary>Kognitif AAS (Teori & Praktik)</summary>
...
| Halaman                                                                                                                        | Deskripsi                        |
| ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------- |
| [Pertemuan 1 — Introduction to Database Concepts](/docs/v1/courses/rpl106-pengantar-basis-data/introduction-database-concepts) | Materi pertemuan pertama.        |
