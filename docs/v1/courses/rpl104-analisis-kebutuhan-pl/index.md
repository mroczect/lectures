...
**Kriteria:** Kejelasan presentasi, kemampuan menjawab, kualitas dokumen Vision & Scope.
:::
...
**Kriteria:** Kelengkapan SRS, ketepatan analisis, kualitas presentasi akhir.
:::
...
**Tanpa SRS yang baik, seluruh mata kuliah lain dalam proyek PBL kehilangan arah.** Dokumen ini adalah acuan tunggal untuk tim frontend, backend, dan basis data.
