...
features:
  - title: 7 Mata Kuliah
    details: Semua tugas dari tujuh mata kuliah semester ini dikumpulkan dalam satu halaman — mudah dilacak dan diingat.
  - title: Status Terkini
    details: Setiap tugas punya status yang jelas — belum dikerjakan, sedang dikerjakan, atau sudah dikumpulkan.
  - title: Deadline Jelas
    details: Tenggat pengumpulan setiap tugas tercatat rapi — tidak ada lagi tugas yang terlewat.
  - title: Tautan Pengumpulan
    details: Langsung menuju halaman tugas di e-learning IF Polibatam — sekali klik, langsung kumpulkan.
  - title: Terintegrasi PBL
    details: Sebagian tugas terhubung ke proyek PBL semester ini — dikerjakan oleh tim, bukan individu.
  - title: Living Document
    details: Halaman ini diperbarui setiap ada tugas baru atau perubahan status — cek berkala.
---
...
```mermaid
flowchart LR
    A["1. Tugas<br/>diumumkan"] --> B["2. Baca<br/>instruksi"]
    B --> C["3. Kerjakan<br/>tugas"]
    C --> D["4. Cek<br/>kelengkapan"]
    D --> E["5. Kumpulkan<br/>via e-learning"]
    E --> F["6. Verifikasi<br/>pengumpulan"]
