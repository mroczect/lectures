...
description: Informasi penting seputar perkuliahan TRPL Polibatam — kontak dosen, jadwal kuliah, info tim PBL, dan judul proyek PBL.
layout: home

hero:
  name: Informasi Perkuliahan
  text: Informasi Penting Seputar Perkuliahan
  tagline: Kontak dosen, jadwal kuliah, tim PBL, dan judul proyek — semua yang kamu butuhkan untuk menjalani semester ini dengan lancar.
  actions:
    - theme: brand
...
features:
  - title: Kontak Dosen
    details: Daftar lengkap dosen pengampu dengan NIK, inisial, nama, email, dan nomor HP.
    link: /v1/information/kontak-dosen
  - title: Jadwal Kuliah
    details: Jadwal mingguan kelas malam TRPL — mata kuliah, dosen pengajar, ruangan, dan jam pelaksanaan.
    link: /v1/information/jadwal-kuliah
  - title: Info Tim PBL
    details: Struktur tim, peran anggota, mekanisme kerja, dan alur Project-Based Learning.
...
```mermaid
flowchart TB
    ROOT["Informasi<br/>Perkuliahan"]

    ROOT --> KD["Kontak Dosen<br/><i>Siapa yang mengajar?</i>"]
    ROOT --> JK["Jadwal Kuliah<br/><i>Kapan & di mana?</i>"]
    ROOT --> IT["Info Tim PBL<br/><i>Bagaimana tim bekerja?</i>"]
    ROOT --> JT["Judul & Tim PBL<br/><i>Apa proyeknya & dengan siapa?</i>"]

    KD -.->|"Dosen pengampu"| JK
    JK -.->|"Sesi praktikum"| IT
    IT -.->|"Pembagian tim"| JT
    JT -.->|"Judul proyek"| IT

    style ROOT fill:#3e63dd,color:#fff
    style KD fill:#2f6f4e,color:#fff
    style JK fill:#4fbf8c,color:#fff
    style IT fill:#6a6a71,color:#fff
    style JT fill:#6bcfaa,color:#fff
```
...
```mermaid
flowchart LR
    A["1. Cek<br/>Jadwal Kuliah"] --> B["2. Kenali<br/>Dosen Pengampu"]
    B --> C["3. Pahami<br/>Struktur Tim PBL"]
    C --> D["4. Kerjakan<br/>Proyek PBL"]
    D --> E["5. Update<br/>Informasi"]
