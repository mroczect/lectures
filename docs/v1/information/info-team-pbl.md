...
# Informasi Tim Project-Based Learning (PBL)

Halaman ini memuat daftar **tim PBL** beserta judul, deskripsi, fitur utama, dan dosen manajer proyek (Manpro) untuk **Semester Ganjil 2026/2027**.
...
## Ringkasan Tim dan Proyek

| No. | Kode PBL    | Judul Proyek                                 | Manpro      | Tim |
| --- | ----------- | -------------------------------------------- | ----------- | --- |
...
::: tip Panduan Lengkap
Panduan lengkap dan pembagian tim dapat dilihat pada [Panduan Project-Based Learning Semester 1 Ganjil 2026-2027](https://polibatam.id/tim-pbl-sem1-trpl-2026).
:::
