...
slug: /v1/information/kontak-dosen
sidebar_position: 10
---

# Kontak Dosen

54 dosen Jurusan Teknik Informatika, diurutkan berdasarkan inisial. Inisial ini yang dipakai di [jadwal kuliah](/docs/v1/information/jadwal-kuliah) dan dokumen resmi.

Nomor HP sesuai data terakhir. Untuk keperluan resmi, hubungi sekretariat Jurusan TI.
...
Beberapa dosen praktikum (Iqbal Afif, Supardianto, Kevin Riady, Banu Failasuf) tidak ada di tabel utama — kemungkinan dari jurusan lain atau belum masuk snapshot data. Untuk kontak, hubungi sekretariat Jurusan TI.

## Etika Menghubungi

-   Gunakan email resmi untuk hal akademik.
-   Sebutkan nama, NIM, kelas, mata kuliah.
-   Bahasa sopan dan formal.
-   Hormati jam kerja — hindari di luar jam wajar.
-   Beri waktu respons 1–2 hari.
-   Untuk hal sensitif, gunakan kanal resmi jurusan.

Nomor HP itu kontak alternatif, bukan kanal utama.

## FAQ

**Kenapa sebagian dosen tidak ada di daftar?**
Mungkin dari jurusan lain atau belum terdaftar. Hubungi sekretariat Jurusan TI.

**Boleh pakai nomor HP untuk konsultasi?**
Untuk hal akademik, prioritaskan email resmi dan e-learning.

**Apa itu NIK?**
Nomor Induk Karyawan, dipakai untuk surat menyurat resmi.

**Data tidak akurat, bagaimana?**
Verifikasi lewat situs resmi jurusan atau e-learning, konfirmasi ke sekretariat.
