  ...
  ((t.version = "0.9.5"),
    ...
    (t.Index.prototype.search = function (e, n) {
      ...
      var o = new t.Configuration(i, this.getFields()).get(),
        r = this.pipeline.run(t.tokenizer(e)),
        s = {};
      for (var u in o) {
        var a = this.fieldSearch(r, u, o),
          l = o[u].boost;
        for (var d in a) a[d] = a[d] * l;
        for (var d in a) d in s ? (s[d] += a[d]) : (s[d] = a[d]);
      }
      var c = [];
      for (var d in s) c.push({ ref: d, score: s[d] });
      return (
        c.sort(function (e, t) {
      ...
      return 0 !== r
        ? (e.forEach(function (e) {
            ...
            (n.forEach(function (n) {
              ...
              if (s && "AND" == i) {
                var l = {};
                for (var d in s) d in o && (l[d] = o[d]);
                o = l;
              }
              n == e && this.fieldSearchStats(u, n, o);
              for (var d in o) {
                var c = this.index[t].getTermFrequency(n, d),
                  f = this.documentStore.getFieldLength(d, t),
                  h = 1;
                0 != f && (h = 1 / Math.sqrt(f));
                var p = 1;
      ...
      var e = {
        ...
        z = function (n) {
          ...
          if (
            ...
            var z = s.exec(n);
            ((s = d), s.test(z[1]) && ((s = y), (n = n.replace(s, ""))));
          } else if (u.test(n)) {
            var z = u.exec(n);
            ((i = z[1]),
              (u = h),
          ...
          if (((s = b), s.test(n))) {
            var z = s.exec(n);
            ((i = z[1]), (o = z[2]), (s = d), s.test(i) && (n = i + e[o]));
          }
          if (((s = E), s.test(n))) {
            var z = s.exec(n);
            ((i = z[1]), (o = z[2]), (s = d), s.test(i) && (n = i + t[o]));
          }
          if (((s = D), (u = F), s.test(n))) {
            var z = s.exec(n);
            ((i = z[1]), (s = c), s.test(i) && (n = i));
          } else if (u.test(n)) {
            var z = u.exec(n);
            ((i = z[1] + z[2]), (u = c), u.test(i) && (n = i));
          }
          if (((s = _), s.test(n))) {
            var z = s.exec(n);
            ((i = z[1]),
